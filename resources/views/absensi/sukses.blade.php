    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <h2 class="mb-3">Keterangan absen berhasil dilakukan!</h2>
                    <p class="text-secondary mb-4">Terima kasih telah melakukan absen. Semoga harimu menyenangkan.</p>
                    <ul class="list-unstyled space-y">
                        ...
                        <li class="row g-2">
                            ...
                            <span class="col">
                                ...
                                <span class="d-block text-secondary">Watch on smart TVs, PlayStation, Xbox, Apple TV,
                    ...
                    <p class="text-secondary">If you need to get a trial extension please feel free to <a
                            href="#">contact us</a>.</p>
                </div>
            </div>
        </div>
